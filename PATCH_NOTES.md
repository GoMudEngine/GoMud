...
## 2026-05-01 — Economy Health Dashboard (dev only)

**Note:** New `/admin/economy/` web dashboard for monitoring NPC supply
chain health. Branch `feature/economy-health-dashboard`, not yet merged
to development or master.
...
- **Startup validator** (`shops.ValidateShopMobTags`) panics if any
  ...
  Server refuses to boot until every shop is categorized.
