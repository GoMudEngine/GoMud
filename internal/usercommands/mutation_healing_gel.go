...
func HealingGel(rest string, user *users.UserRecord, room *rooms.Room, flags events.EventFlag) (bool, error) {
	...
	user.SendTextLegacy(fmt.Sprintf(`<ansi fg="green-bold">A thick, regenerative gel oozes from your pores, knitting wounds as it spreads. (%s)</ansi>`,
	...
	user.SendTextLegacy(`<ansi fg="yellow">The gel weighs you down, slowing your movements.</ansi>`)
