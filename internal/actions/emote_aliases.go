...
// EmoteAliases maps short alias keywords to pre-written emote descriptions.
// Both usercommands and mobcommands use this single source of truth instead
// of maintaining their own duplicate copies.
