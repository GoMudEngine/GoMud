...
// over actions.TriggerToxicBite. Resolves the mob's current Aggro target
// into an Actor. If Aggro is nil or the target cannot be found,
// TriggerToxicBite returns BlockReason="no-target" silently (MobActor.SendText
// is a no-op).
