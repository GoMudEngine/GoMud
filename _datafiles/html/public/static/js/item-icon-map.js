...
(function (global) {
  ...
  var NAME_MAP = {
    ...
    // Legendary BIS gear (rarity_tier 82): 9 pinnacle crafts + 9 Crash Site
    // drops. Unique generated icons (checked before the generic EQUIP_KEYWORDS,
    // so e.g. "staff of the hollow choir" doesn't fall to the generic staff).
    "blackrazor": "blackrazor", "the blackrazor": "blackrazor",
    "staff of the hollow choir": "staff_of_the_hollow_choir",
    "phial of second birth": "phial_of_second_birth",
    "vitalis bandolier": "vitalis_bandolier",
    "wayfarer's bottomless pack": "wayfarers_bottomless_pack",
    "aegis of mockery": "aegis_of_mockery",
    "thornwall harness": "thornwall_harness",
    "seething prism": "seething_prism",
    "zephyr treads": "zephyr_treads",
    "warden's lash": "wardens_lash",
    "relic sidearm": "relic_sidearm",
    "ironhorn warbow": "ironhorn_warbow",
    "coldlight lance": "coldlight_lance",
    "warden-step greaves": "warden_step_greaves",
    "grey warden helm": "grey_warden_helm",
    "greyfield striders": "greyfield_striders",
    "hull-plate cuirass": "hull_plate_cuirass",
    "coldlight mantle": "coldlight_mantle",
    // Arena + Elemental Oasis instance loot pool (near-BIS, 300+ gold entry).
    "earthshaker warhammer": "earthshaker_warhammer",
    "champion mace": "champion_mace",
    "crystal sceptre": "crystal_sceptre",
    "wind scimitar": "wind_scimitar",
    "drowned claws": "drowned_claws",
    "arena tower shield": "arena_tower_shield",
    "arena chain gloves": "arena_chain_gloves",
    "arena iron greaves": "arena_iron_greaves",
    "volcanic plate": "volcanic_plate",
    "ice crown": "ice_crown",
    "mist pauldrons": "mist_pauldrons",
    "stone ring": "stone_ring",
    "storm bracer": "storm_bracer",
    "tidal torc": "tidal_torc"
  };
