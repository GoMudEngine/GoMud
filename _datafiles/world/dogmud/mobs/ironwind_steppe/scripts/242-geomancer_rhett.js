...
function onGive(mob, room, eventDetails) {
    ...
    if ( eventDetails.item.ItemId == SAMPLE_ITEM_ID ) {
        if ( user.HasQuest("11-rhett") && !user.HasQuest("11-samples") ) {
            ...
            mob.Command('say Go back to Kael. He wanted you to see both sides. The choice is yours.', 4.0);
            user.GiveQuest("11-samples");
            return true;
        }
