...
| 5.2 | Hartcharn | 20 | 2 | 🔧 5.2a built | NEW. **Core 5402–5411 built**: south gate, lower market, market square (well/board), the Coachman's Rest inn (ext/common/lodging), posting yard, **Ferry & Coach Agent** (books the Stillwater→NP packet + coach seats), smithy, general store. Attaches Empty Reach 5401→5402. 5.2b residential/north + north gate pending. |
